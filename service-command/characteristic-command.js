...
CommandCharacteristic.prototype.onWriteRequest = function onWriteRequest(data, offset, withoutResponse, callback) {
...
CommandCharacteristic.prototype.processPacket = function processPacket(packet, callback) {
    let command = {};
    try {
    ...
    case 'pulse':
        if (args.color !== undefined && args.duration !== undefined) {
            ...
            try {
                this.tjbot.pulse(args.color, duration);
            } catch (err) {
